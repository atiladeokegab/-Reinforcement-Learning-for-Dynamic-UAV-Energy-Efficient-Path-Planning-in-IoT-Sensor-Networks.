...
BASE_ENV_CONFIG = {
    ...
    "max_battery":        274.0,
    "render_mode":        None,
    # v4a: battery penalty removed — episode termination alone enforces energy budget
    "penalty_battery":    0.0,
    "reward_movement":    10.0,   # unchanged from v3
}
...
SAVE_DIR = Path("models/dqn_v4a")
LOG_DIR  = Path("logs/dqn_v4a")
