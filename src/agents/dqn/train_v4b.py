...
BASE_ENV_CONFIG = {
    ...
    "max_battery":        274.0,
    "render_mode":        None,
    # v4b: battery penalty removed + movement reward 10→200
    # Movement worth ~1/3 of a mediocre SF11 collection step (~600 bytes reward)
    # so agent has a real incentive to navigate toward better sensors
    "penalty_battery":    0.0,
    "reward_movement":    200.0,
}
...
SAVE_DIR = Path("models/dqn_v4b")
LOG_DIR  = Path("logs/dqn_v4b")
