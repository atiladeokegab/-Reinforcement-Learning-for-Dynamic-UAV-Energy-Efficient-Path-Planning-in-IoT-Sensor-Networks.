...
\begin{document}
	...
	%%%%%%%%%%%%%%%%%% APPENDICES %%%%%%%%%%%%%%%%%%
	\begin{uomappendix}
		\input{appendices/project_outline}    % A: Preliminary Project Proposal
		\input{appendices/gantt_chart}        % B: Project Plan and Gantt Chart
		\input{appendices/risk_assessment}    % C: Risk Register + D: H&S Assessment
		\input{appendices/cpd_log}            % E: CPD Log
		\input{appendices/repository}         % F: Code Repository
		\input{appendices/hyperparams}        % G: Hyperparameters
		\input{appendices/sim_to_real}        % H: Sim-to-Real Analysis
		\input{appendices/additional_figures} % I: Additional Figures
	\end{uomappendix}
