...
\caption{Single episode, $400{\times}400$ grid, $N{=}30$, seed 9. Both agents use the same sensor layout. Green circles were collected; red circles were not. The DQN stays near its start corner and collects 10 of 30 sensors (NDR $= 33\%$). The relational policy moves through the grid and collects 28 of 30 (NDR $= 93\%$). Means across 50 seeds are in Table~\ref{tab:scalability_ndr}.}
